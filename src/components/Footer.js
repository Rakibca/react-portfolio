...
function Footer() {
  return (<div className="contact-icons">
    <Row>
      ...
      <Col lg={4} md={12}>
        <a href="https://drive.google.com/file/d/1f6ODHE7gXD7T4dT4hZP7O2z_wzUUMyVv/view?usp=sharing" download="download" target="_blank" rel="noreferrer"><img src="../resume-icon.png" alt="resume-icon" width="80px" class="icon" /></a>
      </Col>
    </Row>
  </div>);
}
